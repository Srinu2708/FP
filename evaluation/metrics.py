...
def hausdorff_distance_95(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=True,
    ...
    if test_empty or test_full or reference_empty or reference_full:
        if nan_for_nonexisting:
            ...
            return hausdorff_distance(test=test, reference=reference, confusion_matrix=confusion_matrix,
                                      nan_for_nonexisting=nan_for_nonexisting, voxel_spacing=voxel_spacing,
...
def surface_dice(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=False, voxel_spacing=None,
                 connectivity=1, distance=5, **kwargs):
    if confusion_matrix is None:
        confusion_matrix = ConfusionMatrix(test, reference)
